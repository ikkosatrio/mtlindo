  ...
  <h4 class="main-heading"><span>List style</span></h4>
    ...
    <div class="list-post">
        <div class="list-post-container">
            <a href="{{base_url('main/detail_novel/').$n->id_novel}}"><img src="{{base_url()}}assets/images/novel/{{$n->cover}}" style="width: 100%; height: auto;" alt=""></a>
            <div class="post-cats"><a href="#">{{$n->nama}}</a></div>
        </div>
        <div class="list-post-body">
            <h2><a href="{{base_url('main/detail_novel/').$n->id_novel}}">{{$n->judul}}</a></h2>

                <div class="post-meta">
                    <span class="post-meta-publ-date">{{$n->created_at}}</span>
            ...
            <p align="justify">{!!read_more($n->deskripsi,500)!!}</p>
