				...
				<div class="page-header page-header-default">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="#">Novel</a></li>
						</ul>
					</div>
				</div>
				<!-- /page header -->
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Daftar Novel</h5>
						...
						<div class="panel-heading">
							<a href="{{base_url('superuser/novel/create')}}"><button type="button" class="btn bg-teal-400 btn-labeled"><b><i class="icon-plus-circle2"></i></b> Tambah Novel</button></a>
						</div>
						<table class="table table-striped datatable-basic table-lg table-responsive">
		                    ...
		                    <tbody>
		                    	@foreach($novel as $key => $result)
		                         <tr>
		                        	<td align="center">{{($key+1)}}</td>
			                        <td>
				                        <a href="{{$result->cover}}" data-popup="lightbox">
					                        <img src="{{img_novel($result->cover)}}" alt="{{$result->cover}}" class="img-rounded img-preview" style="object-fit: cover;height: 70px;">
				                        </a>
			                        </td>
			                        ...
			                        <td class="text-center">
			                           <div class="btn-group">
					                    	...
					                    	<ul class="dropdown-menu dropdown-menu-right">
					                    		<li>
													<a href="{{base_url('main/novel/'.$result->id_novel.'/'.seo($result->judul))}}" target="_blank">
														<i class="fa fa-eye"></i> Lihat Novel Website
													</a>
												</li>
												<li>
													<a href="{{base_url('superuser/chapter/?id_novel='.$result->id_novel)}}">
												...
												data-url="{{base_url('superuser/novel/deleted/'.$result->id_novel.'/'.seo($result->judul))}}">
														<i class="fa fa-trash"></i> Hapus Novel
													</a>
												</li>
											</ul>
										</div>
