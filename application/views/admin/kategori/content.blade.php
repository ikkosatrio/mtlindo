...
@section('content')
	<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="{{base_url('superuser/kategori')}}">Kategori</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<form id="form-blog" class="form-horizontal" action="{{ ($type=='create') ? base_url('superuser/kategori/created') : base_url('superuser/kategori/updated/'.$kategori->id_kategori) }}" method="post">
	...
	$("#form-blog").submit(function(e){
			...
			.done(function(data){
				...
				function(){
					if(data.auth!=false){
						redirect("{{base_url('superuser/kategori')}}");		
						return;
					}
				});
			})
