	...
	<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-heading">
							<a href="{{base_url('superuser/kategoriproduct/create')}}"><button type="button" class="btn bg-teal-400 btn-labeled"><b><i class="icon-plus-circle2"></i></b> Tambah Kategori</button></a>
						</div>
		                    	...
		                    	@foreach($kategori as $key => $result)
		                         <tr>
			                        ...
			                        <td style="width:300px;">
			                        	<a href="{{base_url('superuser/kategoriproduct/update/'.$result->id_kategori.'/'.seo($result->nama))}}">
			                        ...
			                        <td class="text-center">
			                           <div class="btn-group">
					                    	...
					                    	<ul class="dropdown-menu dropdown-menu-right">
												...
												data-url="{{base_url('superuser/kategoriproduct/deleted/'.$result->id_kategori.'/'.seo($result->nama))}}">
