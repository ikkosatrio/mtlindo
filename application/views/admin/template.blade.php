					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="{{match($menu,'novel','active')}}{{match($menu,'novel','active')}}">
									<a href="#"><i class="icon-pencil3"></i> <span>Novel</span></a>
									<ul>
										<li class="{{match($menu,'novel','active')}}"><a href="{{base_url('superuser/novel')}}">Novel</a></li>
										<li class="{{match($menu,'kategori','active')}}"><a href="{{base_url('superuser/kategori')}}">Kategori</a></li>
									</ul>
								</li>
								<li class="{{match($menu,'member','active')}}"><a href="{{base_url('superuser/member')}}"><i class="icon-users"></i> <span>Member</span></a></li>
